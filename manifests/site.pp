...
node 'hp.home.tld' {
	...
	hp_kvm_deb::add_guest { 'trise' :
		...
		local_guest_bcst => '192.168.0.255', local_guest_netw => '192.168.0.0',
		 local_hostname  => 'trise', bridge_name => 'kvmbr0', auto_start => 'true', os_name => 'debian', local_guest_netmask => '255.255.255.0',
    }
	...
	hp_kvm_deb::add_guest { 'mc' :
		...
		local_guest_bcst => '192.168.0.255', local_guest_netw => '192.168.0.0',
		 local_hostname  => 'mc', bridge_name => 'kvmbr0', auto_start => 'true', os_name => 'debian', local_guest_netmask => '255.255.255.0',
    }
	...
	hp_kvm_deb::add_guest { 'deborg' :
		...
		local_guest_bcst => '192.168.0.255', local_guest_netw => '192.168.0.0',
		 local_hostname  => 'deborg', bridge_name => 'kvmbr0', auto_start => 'true', os_name => 'debian', local_guest_netmask => '255.255.255.0',
    }
	...
	hp_kvm_deb::add_guest { 'ilx' :
		...
		local_guest_bcst => '192.168.0.255', local_guest_netw => '192.168.0.0',
		 local_hostname  => 'ilx', bridge_name => 'kvmbr0', auto_start => 'true', os_name => 'debian', local_guest_netmask => '255.255.255.0',
    }
	...
	hp_kvm_deb::add_guest { 'ora' :
		...
		local_guest_bcst => '192.168.0.255', local_guest_netw => '192.168.0.0',
		 local_hostname  => 'ora', bridge_name => 'kvmbr0', auto_start => 'true', os_name => 'oracle6', local_guest_netmask => '255.255.255.0',
    }
